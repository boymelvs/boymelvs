                         ...
                         <ul className="companies">
                              <li className="last_company">
                                   ...
                                   <ul className="responsiblity">
                                        ...
                                        <li>
                                             In-charge for access control system design, installation, supervision, troubleshooting, programming and configuration, testing and
                                             commissioning.
                                        </li>
                                   </ul>
                              </li>
                         ...
                         <ul className="companies">
                              <li className="other_company">
                                   ...
                                   <ul className="responsiblity">
                                        ...
                                        <li>
                                             Responsible for all Access control/CCTV system installations, terminations, supervision, troubleshooting, programming and
